...
func (sm *ArtifactoryServicesManagerImp) CreateMultipleReplication(params services.CreateMultipleReplicationParams) error {
...
func (sm *ArtifactoryServicesManagerImp) UpdateMultipleReplication(params services.UpdateMultipleReplicationParams) error {
...
func (sm *ArtifactoryServicesManagerImp) GetMultipleReplication(repoKey string) ([]utils.MultipleReplicationParams, error) {
...
func (sm *ArtifactoryServicesManagerImp) DeleteMultipleReplication(repoKey, repoUrl string) error {
