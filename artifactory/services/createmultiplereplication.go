...
func NewCreateMultipleReplicationService(client *jfroghttpclient.JfrogHttpClient) *CreateMultipleReplicationService {
	return &CreateMultipleReplicationService{client: client}
}

func (rs *CreateMultipleReplicationService) GetJfrogHttpClient() *jfroghttpclient.JfrogHttpClient {
	return rs.client
}
